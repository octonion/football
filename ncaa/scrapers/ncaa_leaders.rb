...
#?sportCode=MFB&div=1&rptWeeks=17&category=individual&statSeq=504&rptType=CSV&academicYear=2011&doWhat=showrankings
...
#        url = "#{base}?sportCode=MFB&div=#{div}&rptWeeks=8&category=individual&statSeq=#{stat}&rptType=CSV&academicYear=#{year}&doWhat=showrankings"
        url = "#{base}?sportCode=MFB&div=#{div}&category=individual&statSeq=#{stat}&rptType=CSV&academicYear=#{year}&doWhat=showrankings"
